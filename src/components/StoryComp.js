export function StoryComp() {
  return(
    <div className="bg-story p-2">
      <div className="d-flex">
        <div className="col-6 color-yellow text-center">
          <h1 className="heading-bold1">BRAND STORY</h1>
      ...
      <div className="layout-window">
        <div className="col-6" >
          <h2 className="heading-bolder1">WHAT HAPPENED'S BRAND STORY</h2>
          <p className="text-kr-body">청춘이 있는 바이며, 말이다. 같지 노년에게서 어디 모래뿐일 무엇을 풀이 옷을 
